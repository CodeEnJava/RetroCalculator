...
public class JDisplayBTree extends JPanel{
	...
	private void drawJNode(Graphics2D g2, JNode node, int x, int y, int hGap) {
		...
		if(node.getLeftChild()!= null) {
			...
			drawJNode(g2,node.getLeftChild(),childX,childY,hGap/2);
		}
		...
		if(node.getRightChild()!= null) {
			...
			g2.drawLine(x, y+nodeSize/2, childX, childY-nodeSize/2);
			drawJNode(g2,node.getRightChild(),childX,childY,hGap/2);
		}
