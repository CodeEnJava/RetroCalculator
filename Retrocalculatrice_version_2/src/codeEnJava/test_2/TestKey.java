...
public class TestKey {
	...
	public static void main(String[] args) {
		...
		// créer le btn +
		KeyExample btnAdd = new KeyExample(200, 200, "+");
		...
		// créer le btn -
		KeyExample btnSub = new KeyExample(200, 200, "-");
		...
		// créer le btn Clear
		KeyExample btnClear = new KeyExample(150, 150, "C");
		...
		KeyExample[] keyboard = {btnAdd,btnSub,btnClear};
		
		new ProcessKeyDisplay(keyboard, display);
	}
